...
import fanta from '../../../../assets/imagenes/bebidas/gaseosas/fanta.jpg'
import sprite from '../../../../assets/imagenes/bebidas/gaseosas/sprite.jpg'
import cocacola from '../../../../assets/imagenes/bebidas/gaseosas/cocacola.jpg'
import incakola from '../../../../assets/imagenes/bebidas/gaseosas/incakola.jpg'
                                  ...
                                  <div className="default-slider default-slider--hover-bg-red product-default-slider">
                                      <div className="responsive product-default-slider-4grid-2rows gap__col--30 gap__row--40">            
                                          <div className="product__box product__default--single text-center">
                                              <div className="product__img-box  pos-relative">
                                                  <a href="product-single-default.html" className="product__img--link">
                                                      <img className="product__img img-fluid" src={fanta} alt=""/>
                                                  </a>
                                              ...
                                              <div className="product__content m-t-20">
                                                  <a href="product-single-default.html" className="product__link">Fanta</a>
                                          ...
                                          <div className="product__box product__default--single text-center">
                                              ...
                                              <div className="product__content m-t-20">
                                                  <a href="product-single-default.html" className="product__link">Sprite</a>
                                          ...
                                          <div className="product__box product__default--single text-center">
                                              ...
                                              <div className="product__img-box  pos-relative">
                                                  <a href="product-single-default.html" className="product__img--link">
                                                      <img className="product__img img-fluid" src={cocacola} alt=""/>
                                                  </a>
                                              ...
                                              <div className="product__content m-t-20">
                                                  <a href="product-single-default.html" className="product__link">Coca Cola</a>
                                                  <div className="product__price m-t-5">
                                          ...
                                          <div className="product__box product__default--single text-center">
                                              <div className="product__img-box  pos-relative">
                                                  <a href="product-single-default.html" className="product__img--link">
                                                      <img className="product__img img-fluid" src={incakola} alt=""/>
                                                  </a>
                                                  <a className="product__label-1 product__label--sale-out">Agregar</a>
                                                  <ul className="product__action--link pos-absolute">
                                                      <li><a href="#modalAddCart" data-toggle="modal"><i className="icon-shopping-cart"></i></a></li>
                                              ...
                                              <div className="product__content m-t-20">
                                                  <a href="product-single-default.html" className="product__link">Inca Kola</a>
                                                  <div className="product__price m-t-5">
