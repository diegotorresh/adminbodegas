...
import costeño from '../../../../assets/imagenes/abarrotes/arroces/costeño1.jpg'
import tonderito from '../../../../assets/imagenes/abarrotes/arroces/tonderito.jpg'
import paisana from '../../../../assets/imagenes/abarrotes/arroces/paisana.jpg'
import bells from '../../../../assets/imagenes/abarrotes/arroces/bells.jpg'
                                  ...
                                  <div className="default-slider default-slider--hover-bg-red product-default-slider">
                                      <div className="responsive product-default-slider-4grid-2rows gap__col--30 gap__row--40">            
                                          <div className="product__box product__default--single text-center">
                                              <div className="product__img-box  pos-relative">
                                                  <a href="product-single-default.html" className="product__img--link">
                                                      <img className="product__img img-fluid" src={costeño} alt=""/>
                                                  </a>
                                                  <a href="/adminbodegas/productos/agregarproducto"className="product__label-1 product__label--sale-out-1">Agregar</a>
                                          ...
                                          <div className="product__box product__default--single text-center">
                                              ...
                                              <div className="product__img-box  pos-relative">
                                                  <a href="product-single-default.html" className="product__img--link">
                                                      <img className="product__img img-fluid" src={paisana} alt=""/>
                                                  </a>
                                          ...
                                          <div className="product__box product__default--single text-center">
                                              ...
                                              <div className="product__img-box  pos-relative">
                                                  <a href="product-single-default.html" className="product__img--link">
                                                      <img className="product__img img-fluid" src={tonderito} alt=""/>
                                                  </a>
                                          ...
                                          <div className="product__box product__default--single text-center">
                                              <div className="product__img-box  pos-relative">
                                                  <a href="product-single-default.html" className="product__img--link">
                                                      <img className="product__img img-fluid" src={bells} alt=""/>
                                                  </a>
                                                  <a className="product__label-1 product__label--sale-out">Agregar</a>
                                                  <ul className="product__action--link pos-absolute">
                                                      <li><a href="#modalAddCart" data-toggle="modal"><i className="icon-shopping-cart"></i></a></li>
