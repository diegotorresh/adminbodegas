                            ...
                            <div class="col-xl-3 col-md-4">
                                <div class="my-account-alineacion my-account-menu">
                                    <ul class="nav my-account-alineacion account-menu-list flex-column nav-pills" id="pills-tab" role="tablist">
                                        ...
                                        <li>
                                            <a id="pills-order-tab" class="active link--icon-left" href="/adminbodegas/productos/nuevoproducto/carnes"><i
                                ...
                                <div class="alineacion abarrotes tab-content my-account-tab" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-order" role="tabpanel" aria-labelledby="pills-order-tab">
                                        <div class="my-account-order account-wrapper">
                                            <h4 class="account-title">Carnes</h4>
                                            <div class="botones_seccion account-table text-center m-t-30 table-responsive">
                                                <a href="#modalAddCart" data-toggle="modal" class="btn btn--box btn--small btn--radius btn--green btn--green-hover-black btn--uppercase font--semi-bold">POLLO</a>
                                                <a href="#modalAddCart" data-toggle="modal" class="btn btn--box btn--small btn--radius btn--green btn--green-hover-black btn--uppercase font--semi-bold">RES</a>
                                            </div>
                                            <div class="botones_seccion account-table text-center m-t-30 table-responsive">
                                                <a href="#modalAddCart" data-toggle="modal" class="btn btn--box btn--small btn--radius btn--green btn--green-hover-black btn--uppercase font--semi-bold">CHANCHO</a>
                                                <a href="#modalAddCart" data-toggle="modal" class="btn btn--box btn--small btn--radius btn--green btn--green-hover-black btn--uppercase font--semi-bold">PESCADO</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
